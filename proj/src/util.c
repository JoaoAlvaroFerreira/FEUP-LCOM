...
Objeto_texto *create_objeto_texto(char *string, int x, int y,
  ...
  for (unsigned int i = 0; i < strlen(string); i++) {
    sprintf(filename, "/home/lcom/labs/proj/src/images/characters/%c.bmp",
            string[i]);
...
Cliente *create_cliente(int x, int y, Alignment alignment) {
  ...
  Bitmap *bmp;
  if (random == 0) {
    bmp = loadBitmap("/home/lcom/labs/proj/src/images/clients/grandma1.bmp");
  } else if (random == 1) {
    bmp = loadBitmap("/home/lcom/labs/proj/src/images/clients/grandma2.bmp");
  } else if (random == 2) {
    bmp = loadBitmap(
        "/home/lcom/labs/proj/src/images/clients/strollergrandma.bmp");
  } else if (random == 3) {
    bmp = loadBitmap("/home/lcom/labs/proj/src/images/clients/wheelchair.bmp");
  } else if (random == 4) {
    bmp = loadBitmap("/home/lcom/labs/proj/src/images/clients/caneguy.bmp");
  } else {
    bmp = loadBitmap("/home/lcom/labs/proj/src/images/clients/crazyguy.bmp");
  }
  cli->bitmap = bmp;
  cli->x = x;
  cli->y = y;
  ...
  for (unsigned int i = 0; i < numero_clientes; i++) {
    if (clientes[i]->timeLeft <= 0) {
      if (move_cliente_coordenadas(clientes[i], -300, Y_CLIENTE) != OK) {
        ...
        if (random == 0) {
          bmp =
              loadBitmap("/home/lcom/labs/proj/src/images/clients/grandma1.bmp");
        } else if (random == 1) {
          bmp =
              loadBitmap("/home/lcom/labs/proj/src/images/clients/grandma2.bmp");
        } else if (random == 2) {
          bmp = loadBitmap(
              "/home/lcom/labs/proj/src/images/clients/strollergrandma.bmp");
        } else if (random == 3) {
          bmp = loadBitmap(
              "/home/lcom/labs/proj/src/images/clients/wheelchair.bmp");
        } else if (random == 4) {
          bmp =
              loadBitmap("/home/lcom/labs/proj/src/images/clients/caneguy.bmp");
        } else {
          bmp =
              loadBitmap("/home/lcom/labs/proj/src/images/clients/crazyguy.bmp");
        }
