...
/**
 * @brief reads the command byte from the outbuf
 * 
 * @return unsigned int 
 */
...
/**
 * @brief writes a command byte to the outbuf
 * 
 * @param data 
 * @return unsigned int 
 */
...
/**
 * @brief enables IH for when the keyboard is used with polling
 * 
 * @return int 
 */
int enableIH() {
...
/**
 * @brief gets Scancodes by the keyboard and saves them to a global variable
 * 
 */
...
/**
 * @brief deals with the keyboard interrupts and processs them, used by scanCodeReader()
 * 
 */
